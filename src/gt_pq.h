...
#define DEFAULT_UTHREAD_CREDITS 25 
#define DEFAULT_UTHREAD_EXEC_TIME 0
#define DEFAULT_UTHREAD_CAP 0 
#define DEFAULT_UTHREAD_WEIGHT 1024
#define DEFAULT_TIME_SLICE 15
#define DEFAULT_TOTAL_WEIGHT DEFAULT_UTHREAD_WEIGHT * 85
